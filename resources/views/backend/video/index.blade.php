...
@section('title2')
    <section class="content-header">
        <h1>
            <a href="{{ route('backend.videos.create') }}" class="btn btn-primary btn-block margin-bottom"><i class="fa fa-pencil-square-o"></i>Create</a>
            ...
            <div class="col-xs-12">
                ...
                <div class="box">
                    <div class="box-header">
                        <h3 class="box-title">Video Management</h3>
                    </div>
                    @if(session('message'))
                            ...
                            <tbody>
                                @forelse($data['rows'] as $i=>$row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('backend.videos.show',$row->id)}}" class="btn btn-warning" type="button"><i class="fa fa-eye" aria-hidden="true"></i></a>
                                            <a href="{{route('backend.videos.edit', $row->id)}}" type="button" class="btn btn-info"><i class="fa fa-edit" aria-hidden="true"></i></a>

                                        {!! Form::open(['method'=>'DELETE', 'url' =>route('backend.videos.destroy', $row->id),'style' => 'display:inline']) !!}
